...
use domain
!tha use advection, only: NADV, NADVS

implicit none

integer, parameter :: NADV = 0
integer, parameter :: NADVS = 0

character(6), parameter :: version = '6.10.6'
character(8), parameter :: version_date = 'May 2014'
...
logical, parameter :: RUN3D = ny.gt.1
