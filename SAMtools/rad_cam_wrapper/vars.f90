...
! twc - 2017-01-11 -- added variables for output
real tabs1_xy(nx,ny) ! lowest-level air temperature
real qv1_xy(nx,ny)   ! lowest-level mixing ratio
real tbar_xy(nx,ny)  ! column-integrated mean temperature
